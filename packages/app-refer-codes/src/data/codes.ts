...
export const brands: Brand[] = [
  { key: 'airbnb',       name: 'Airbnb',                   logoUrl: '/brands/airbnb_wordmark.svg',      theme: 'dark'  },
  { key: 'chase',        name: 'Chase',                    logoUrl: '/brands/chase_wordmark.svg',       theme: 'light' },
  { key: 'coinbase',     name: 'coinbase',                 logoUrl: '/brands/coinbase_wordmark.svg',    theme: 'dark'  },
  { key: 'doordash',     name: 'DoorDash',                 logoUrl: '/brands/doordash_wordmark.svg',    theme: 'dark'  },
  { key: 'lyft',         name: 'Lyft',                     logoUrl: '/brands/lyft_wordmark.svg',        theme: 'dark'  },
  { key: 'mint-mobile',  name: 'Mint Mobile',              logoUrl: '/brands/mint_mobile_wordmark.svg', theme: 'dark'  },
  { key: 'prenuvo',      name: 'Prenuvo',                  logoUrl: '/brands/prenuvo_wordmark.svg',     theme: 'light' },
  { key: 'pia',          name: 'Private Internet Access',  logoUrl: '/brands/pia_wordmark.svg',         theme: 'light' },
  { key: 'purple',       name: 'Purple',                   logoUrl: '/brands/purple_wordmark.svg',      theme: 'dark'  },
  { key: 'turbotax',     name: 'TurboTax',                 logoUrl: '/brands/turbotax_wordmark.svg',    theme: 'dark'  },
  { key: 'uber',         name: 'Uber',                     logoUrl: '/brands/uber_wordmark.svg',        theme: 'light' },
  { key: 'wise',         name: 'Wise',                     logoUrl: '/brands/wise_wordmark.svg',        theme: 'dark'  },
]
...
export const codes: Code[] = [
  ...
  { key: 'pia',            brandKey: 'pia',          description: 'Get 30 days free',                                         url: 'https://www.privateinternetaccess.com/pages/buy-a-vpn/1218buyavpn?invite=U2FsdGVkX18P77qeez2G2JCh0J3YNx-hKan2ba92y9g%2CmsfRst0pmkdlVUDQZ33lJdCtHW0' },
